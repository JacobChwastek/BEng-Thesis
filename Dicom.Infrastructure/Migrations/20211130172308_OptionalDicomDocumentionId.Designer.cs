...
namespace Dicom.Infrastructure.Migrations
{
    ...
    [Migration("20211130172308_OptionalDicomDocumentionId")]
    partial class OptionalDicomDocumentionId
    {
            ...
            modelBuilder.Entity("Dicom.Entity.Dicom.DicomDocumentation", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_dicom_documentations");

                    b.HasIndex("DicomId")
                        .HasDatabaseName("ix_dicom_documentations_dicom_id");

                    b.ToTable("dicom_documentations");
                });
            ...
            modelBuilder.Entity("Dicom.Entity.Dicom.DocumentationImage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_documentation_images");

                    b.HasIndex("DicomDocumentationId")
                        .HasDatabaseName("ix_documentation_images_dicom_documentation_id");

                    b.ToTable("documentation_images");
                });
            ...
            modelBuilder.Entity("Dicom.Entity.Dicom.DicomDocumentation", b =>
                {
                    b.HasOne("Dicom.Entity.Dicom.Dicom", "Dicom")
                        ...
                        .HasConstraintName("fk_dicom_documentations_dicom_dicom_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
